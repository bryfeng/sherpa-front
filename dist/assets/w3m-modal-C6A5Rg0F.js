import{ab as m,aK as D,R as l,j as ue,c as $,r as H,a as g,i as y,x as c,n as u,a3 as z,o as B,a4 as d,e as he,b as f,a0 as U,aF as pe,ai as K,E as J,O,t as M,A as V,h as me,S as P,aL as _,aC as Q,a2 as fe,a1 as ae,aM as we,P as be,C as ge,k as ye}from"./index-D4xP87V4.js";import{S as ve}from"./SwapController-DkH28uQS.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await D.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
