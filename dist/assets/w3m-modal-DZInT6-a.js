import{ew as m,fb as _,dC as l,dD as ue,de as $,df as L,di as g,dj as y,dk as c,dh as u,e6 as z,dI as B,e7 as d,dg as he,dt as f,e3 as U,f6 as pe,eD as K,dp as J,dm as O,dK as X,dq as V,dz as me,ds as P,fc as D,f3 as Q,e5 as fe,e4 as ae,fd as we,dl as be,dr as ge,dE as ye}from"./index-B8UX-kGC.js";import{S as ve}from"./SwapController-BnWfJOb8.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await _.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
