import{dM as m,ej as D,c_ as l,c$ as ue,cD as $,cE as L,cH as g,cI as y,cJ as c,cG as u,dh as z,d4 as B,di as d,cF as he,cR as f,de as U,ee as pe,dT as K,cN as J,cL as O,d6 as X,cO as V,cX as me,cQ as P,ek as _,eb as Q,dg as fe,df as ae,el as we,cK as be,cP as ge,d0 as ye}from"./index-4K1dqGvy.js";import{S as ve}from"./SwapController-CF0DhOTF.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await D.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
