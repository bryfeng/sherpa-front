import{ez as m,ff as _,dC as l,dD as ue,de as $,df as L,di as g,dj as y,dk as c,dh as u,e8 as z,dI as B,e9 as d,dg as he,dt as f,e5 as U,fa as pe,eG as K,dp as J,dm as O,dK as X,dq as V,dz as me,ds as P,fg as D,f7 as Q,e7 as fe,e6 as ae,fh as we,dl as be,dr as ge,dE as ye}from"./index-rkOzlyuE.js";import{S as ve}from"./SwapController-ByAwkcx1.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await _.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
