import{cD as I,di as l,cG as w,cH as A,cI as D,cR as E,cY as h,cJ as u,cS as K,cN as W,c_ as $,cO as U,cP as M,dM as F,d1 as Q,d2 as H,cE as z,cF as q,ef as j}from"./index-4K1dqGvy.js";import{S as r}from"./SwapController-CF0DhOTF.js";import"./index-CZJ-zXcc.js";const G={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",P=a==="v",_=a==="x",L=n===",",O=n===".",N=n>="0"&&n<="9";!s&&(c||b||P||_)&&e.preventDefault(),t==="0"&&!L&&!O&&n==="0"&&e.preventDefault(),t==="0"&&N&&(o(n),e.preventDefault()),(L||O)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!N&&!i.includes(n)&&!O&&!L&&e.preventDefault()}},Y=I`
  :host {
    width: 100%;
  }
...
`;var T=function(e,t,o,i){var s=arguments.length,n=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(s<3?a(n):s>3?a(t,o,n):a(t,o))||n);return s>3&&n&&Object.defineProperty(t,o,n),n};const J=K.CONVERT_SLIPPAGE_TOLERANCE;let g=class extends D{constructor(){var t;super(),this.unsubscribe=[],this.networkName=(t=E.state.activeCaipNetwork)==null?void 0:t.name,this.detailsOpen=!1,this.sourceToken=r.state.sourceToken,this.toToken=r.state.toToken,this.toTokenAmount=r.state.toTokenAmount,this.sourceTokenPriceInUSD=r.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=r.state.toTokenPriceInUSD,this.priceImpact=r.state.priceImpact,this.maxSlippage=r.state.maxSlippage,this.networkTokenSymbol=r.state.networkTokenSymbol,this.inputError=r.state.inputError,this.unsubscribe.push(r.subscribe(o=>{this.sourceToken=o.sourceToken,this.toToken=o.toToken,this.toTokenAmount=o.toTokenAmount,this.priceImpact=o.priceImpact,this.maxSlippage=o.maxSlippage,this.sourceTokenPriceInUSD=o.sourceTokenPriceInUSD,this.toTokenPriceInUSD=o.toTokenPriceInUSD,this.inputError=o.inputError}))}render(){const t=this.toTokenAmount&&this.maxSlippage?h.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const o=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};g.styles=[Y];T([l()],g.prototype,"networkName",void 0);T([w()],g.prototype,"detailsOpen",void 0);T([l()],g.prototype,"sourceToken",void 0);T([l()],g.prototype,"toToken",void 0);T([l()],g.prototype,"toTokenAmount",void 0);T([l()],g.prototype,"sourceTokenPriceInUSD",void 0);T([l()],g.prototype,"toTokenPriceInUSD",void 0);T([l()],g.prototype,"priceImpact",void 0);T([l()],g.prototype,"maxSlippage",void 0);T([l()],g.prototype,"networkTokenSymbol",void 0);T([l()],g.prototype,"inputError",void 0);g=T([A("w3m-swap-details")],g);const X=I`
  :host {
    width: 100%;
  }
...
`;var V=function(e,t,o,i){var s=arguments.length,n=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(s<3?a(n):s>3?a(t,o,n):a(t,o))||n);return s>3&&n&&Object.defineProperty(t,o,n),n};let R=class extends D{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};R.styles=[X];V([w()],R.prototype,"target",void 0);R=V([A("w3m-swap-input-skeleton")],R);const Z=I`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var C=function(e,t,o,i){var s=arguments.length,n=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(s<3?a(n):s>3?a(t,o,n):a(t,o))||n);return s>3&&n&&Object.defineProperty(t,o,n),n};let S=class extends D{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var o;if(!this.visible)return null;const t=this.amount&&this.price?(o=h.multiply(this.price,this.amount))==null?void 0:o.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};S.styles=[z,q,ie];C([w()],S.prototype,"imageSrc",void 0);C([w()],S.prototype,"name",void 0);C([w()],S.prototype,"symbol",void 0);C([w()],S.prototype,"price",void 0);C([w()],S.prototype,"amount",void 0);C([l()],S.prototype,"visible",void 0);C([l()],S.prototype,"imageError",void 0);S=C([A("wui-token-list-item")],S);const ne=I`
  :host {
    width: 100%;
  }
