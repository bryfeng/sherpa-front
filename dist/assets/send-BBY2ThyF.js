import{c as f,n as d,a2 as c,a as m,i as w,aI as O,C as N,b as g,j as H,bb as l,aJ as D,x as u,r as W,e as V,bc as M,bd as q,R as v,N as L,$,a1 as Y,Z as J,S as _,k as K,E as Z,l as G,W as Q}from"./index-Bs3v3zT3.js";import"./index-BVjL6r5p.js";import{S as F}from"./SwapController-QRz2SETd.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var E=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let A=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var t;return(t=this.inputElementRef)!=null&&t.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
      ${D(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
...
`;var z=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let P=class extends w{render(){return u` <wui-flex
    ...
    >`}handleSelectButtonClick(){v.push("WalletSendSelectToken")}sendValueTemplate(){if(this.token&&this.sendTokenAmount){const n=this.token.price*this.sendTokenAmount;return u`<wui-text class="totalValue" variant="sm-regular" color="secondary"
      ...
      >`}return null}maxAmountTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u` <wui-text variant="sm-regular" color="error">
        ...
        ${$.roundNumber(Number(this.token.quantity.numeric),6,5)}
      </wui-text>`:null}actionTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u`<wui-link @click=${this.onBuyClick.bind(this)}>Buy</wui-link>`:u`<wui-link @click=${this.onMaxClick.bind(this)}>Max</wui-link>`:null}onInputChange(t){l.setTokenAmount(t.detail)}onMaxClick(){if(this.token){const t=L.bigNumber(this.token.quantity.numeric);l.setTokenAmount(Number(t.toFixed(20)))}}onBuyClick(){v.push("OnRampProviders")}};P.styles=te;z([d({type:Object})],P.prototype,"token",void 0);z([d({type:Number})],P.prototype,"sendTokenAmount",void 0);P=z([m("w3m-input-token")],P);const ie=f`
  :host {
    display: block;
  }
...
`;var k=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let p=class extends w{constructor(){super(),this.unsubscribe=[],this.token=l.state.token,this.sendTokenAmount=l.state.sendTokenAmount,this.receiverAddress=l.state.receiverAddress,this.receiverProfileName=l.state.receiverProfileName,this.loading=l.state.loading,this.message="Preview Send",this.token&&(this.fetchBalances(),this.fetchNetworkPrice()),this.unsubscribe.push(l.subscribe(t=>{this.token=t.token,this.sendTokenAmount=t.sendTokenAmount,this.receiverAddress=t.receiverAddress,this.receiverProfileName=t.receiverProfileName,this.loading=t.loading}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return this.getMessage(),u` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    </wui-flex>`}async fetchBalances(){await l.fetchTokenBalance(),l.fetchNetworkBalance()}async fetchNetworkPrice(){await F.getNetworkTokenPrice()}onButtonClick(){v.push("WalletSendPreview")}getMessage(){var t;this.message="Preview Send",this.receiverAddress&&!N.isAddress(this.receiverAddress,g.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&((t=this.token)!=null&&t.price)&&(this.sendTokenAmount*this.token.price||(this.message="Incorrect Value")),this.token||(this.message="Select Token")}};p.styles=ie;k([c()],p.prototype,"token",void 0);k([c()],p.prototype,"sendTokenAmount",void 0);k([c()],p.prototype,"receiverAddress",void 0);k([c()],p.prototype,"receiverProfileName",void 0);k([c()],p.prototype,"loading",void 0);k([c()],p.prototype,"message",void 0);p=k([m("w3m-wallet-send-view")],p);const ne=f`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var S=function(e,t,n,r){var o=arguments.length,i=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(o<3?s(i):o>3?s(t,n,i):s(t,n))||i);return o>3&&i&&Object.defineProperty(t,n,i),i};let b=class extends w{constructor(){super(),this.unsubscribe=[],this.tokenBalances=l.state.tokenBalances,this.search="",this.onDebouncedSearch=N.debounce(t=>{this.search=t}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(l.subscribe(t=>{this.tokenBalances=t.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return u`
    ...
    `}onBuyClick(){v.push("OnRampProviders")}onInputChange(t){this.onDebouncedSearch(t.detail)}handleTokenClick(t){l.setToken(t),l.setTokenAmount(void 0),v.goBack()}};b.styles=ne;S([c()],b.prototype,"tokenBalances",void 0);S([c()],b.prototype,"tokens",void 0);S([c()],b.prototype,"filteredTokens",void 0);S([c()],b.prototype,"search",void 0);b=S([m("w3m-wallet-send-select-token-view")],b);const re=f`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
