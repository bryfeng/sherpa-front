import{de as I,e7 as l,dh as w,di as A,dj as D,dt as E,dA as h,dk as u,du as K,dp as W,dC as $,dq as U,dr as M,ew as F,dF as Q,dG as q,df as z,dg as H,f7 as j}from"./index-B8UX-kGC.js";import{S as r}from"./SwapController-BnWfJOb8.js";import"./index-BAb357Qx.js";const G={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",P=a==="v",_=a==="x",L=n===",",O=n===".",N=n>="0"&&n<="9";!s&&(c||b||P||_)&&e.preventDefault(),t==="0"&&!L&&!O&&n==="0"&&e.preventDefault(),t==="0"&&N&&(o(n),e.preventDefault()),(L||O)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!N&&!i.includes(n)&&!O&&!L&&e.preventDefault()}},X=I`
  :host {
    width: 100%;
  }
