import{de as g,dj as y,dt as f,dk as r,dC as w,ds as p,dq as P,dD as k,e7 as u,di as b,dr as A}from"./index-B8UX-kGC.js";import{E as i}from"./ExchangeController-DdxvX1OM.js";const I=g`
      ...
      <wui-flex flexDirection="column" gap="3" .padding=${["0","3","3","3"]} class="amount-input-container">
        ...
        <wui-flex flexDirection="column" alignItems="center" justifyContent="center">
          ...
          <wui-flex justifyContent="space-between" gap="2">
            ${v.map(t=>r`<wui-button @click=${()=>this.onPresetAmountClick(t)} variant=${this.amount===t?"neutral-primary":"neutral-secondary"} size="sm" fullWidth>$${t}</wui-button>`)}
          </wui-flex>
        </wui-flex>
      </wui-flex>
...
`;var x=function(s,e,n,t){var a=arguments.length,o=a<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,n):t,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,n,t);else for(var d=s.length-1;d>=0;d--)(m=s[d])&&(o=(a<3?m(o):a>3?m(e,n,o):m(e,n))||o);return a>3&&o&&Object.defineProperty(e,n,o),o};let h=class extends y{constructor(){super(),this.unsubscribe=[],this.assets=i.state.assets,this.search="",this.onDebouncedSearch=A.debounce(e=>{this.search=e}),this.unsubscribe.push(i.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return r`
