import{c as P,a3 as l,n as w,b as A,i as D,d as E,N as h,x as u,f as K,E as W,R as $,A as U,C as M,aI as F,m as Q,W as q,r as z,e as H,bb as j}from"./index-DqkAUW6j.js";import{S as r}from"./SwapController-D1yawNoM.js";import"./index-EY9g_6tp.js";const G={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",_=a==="x",L=n===",",O=n===".",N=n>="0"&&n<="9";!s&&(c||b||I||_)&&e.preventDefault(),t==="0"&&!L&&!O&&n==="0"&&e.preventDefault(),t==="0"&&N&&(o(n),e.preventDefault()),(L||O)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!N&&!i.includes(n)&&!O&&!L&&e.preventDefault()}},X=P`
  :host {
    width: 100%;
  }
