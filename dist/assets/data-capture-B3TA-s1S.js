import{dr as $,db as y,dc as l,d9 as S,da as x,de as m,du as p,dk as f,dj as h,e2 as u,d$ as _,el as E,em as C}from"./index-vTXeJqHX.js";import{W as R}from"./index-BRPeJL2r.js";import{ReownAuthentication as v}from"./features-B_G0yKiD.js";const j=$`
  .email-sufixes {
    display: flex;
    flex-direction: row;
...
`;var O=function(o,t,i,a){var n=arguments.length,e=n<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,i):a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(o,t,i,a);else for(var s=o.length-1;s>=0;s--)(r=o[s])&&(e=(n<3?r(e):n>3?r(t,i,e):r(t,i))||e);return n>3&&e&&Object.defineProperty(t,i,e),e};const D=["@gmail.com","@outlook.com","@yahoo.com","@hotmail.com","@aol.com","@icloud.com","@zoho.com"];let g=class extends y{constructor(){super(...arguments),this.email=""}render(){const t=D.filter(this.filter.bind(this)).map(this.item.bind(this));return t.length===0?null:l`<div class="email-sufixes">${t}</div>`}filter(t){if(!this.email)return!1;const i=this.email.split("@");if(i.length<2)return!0;const a=i.pop();return t.includes(a)&&t!==`@${a}`}item(t){return l`<wui-button variant="neutral" size="sm" @click=${()=>{const a=this.email.split("@");a.length>1&&a.pop();const n=a[0]+t;this.dispatchEvent(new CustomEvent("change",{detail:n,bubbles:!0,composed:!0}))}}
      >${t}</wui-button
    >`}};g.styles=[j];O([S()],g.prototype,"email",void 0);g=O([x("w3m-email-suffixes-widget")],g);const I=$`
  .recent-emails {
    display: flex;
