import{ev as m,f2 as D,du as l,dv as ue,d6 as $,d7 as L,da as g,db as y,dc as c,d9 as u,e3 as z,dA as B,e4 as d,d8 as he,dk as f,e0 as U,eZ as pe,eC as V,dg as J,de as O,dC as X,dh as K,dr as me,dj as A,f3 as _,eW as Q,e2 as fe,e1 as ae,f4 as we,dd as be,di as ge,dw as ye}from"./index-DphROJOb.js";import{S as ve}from"./SwapController--9Z3LcaP.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await D.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
