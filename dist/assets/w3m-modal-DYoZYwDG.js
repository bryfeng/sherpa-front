import{aI as m,bf as D,R as l,k as ue,c as $,r as L,b as g,i as y,x as c,n as u,a2 as z,q as B,a3 as d,e as he,d as f,$ as U,ba as pe,aP as V,E as J,O,u as X,A as K,j as me,S as P,bg as _,b7 as Q,a1 as fe,a0 as ae,bh as we,P as be,C as ge,l as ye}from"./index-QXtFqy1l.js";import{S as ve}from"./SwapController-RzMQVp8t.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await D.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
