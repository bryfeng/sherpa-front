import{eG as m,fn as _,dC as l,dD as ue,de as $,df as L,di as g,dj as y,dk as c,dh as u,e8 as z,dI as B,e9 as d,dg as he,dt as f,e5 as U,fi as pe,eN as K,dp as J,dm as O,dK as X,dq as V,dz as me,ds as P,fo as D,ff as Q,e7 as fe,e6 as ae,fp as we,dl as be,dr as ge,dE as ye}from"./index-Dide1ZUj.js";import{S as ve}from"./SwapController-I1up8q1c.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await _.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
