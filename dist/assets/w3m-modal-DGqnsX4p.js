import{aH as m,be as D,R as l,j as ue,c as $,r as L,a as g,i as y,x as c,n as u,a1 as z,o as B,a2 as d,e as he,b as f,Z as U,b9 as pe,aO as V,E as J,O,t as X,A as K,h as me,S as P,bf as _,b6 as Q,a0 as fe,$ as ae,bg as we,P as be,C as ge,k as ye}from"./index-Cc5zWaob.js";import{S as ve}from"./SwapController-D4COg15b.js";const re={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){m.shake();return}if(await D.isSIWXCloseDisabled()){m.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ue.disconnect(),m.close()}},xe=$`
  :host {
    display: block;
