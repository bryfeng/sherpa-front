import{cD as g,cI as y,cR as f,cJ as r,c_ as w,cQ as p,cO as P,c$ as k,di as u,cH as b,cP as I}from"./index-4K1dqGvy.js";import{E as i}from"./ExchangeController-BkRLkviq.js";const A=g`
      ...
      <wui-flex flexDirection="column" gap="3" .padding=${["0","3","3","3"]} class="amount-input-container">
        ...
        <wui-flex flexDirection="column" alignItems="center" justifyContent="center">
          ...
          <wui-flex justifyContent="space-between" gap="2">
            ${$.map(t=>r`<wui-button @click=${()=>this.onPresetAmountClick(t)} variant=${this.amount===t?"neutral-primary":"neutral-secondary"} size="sm" fullWidth>$${t}</wui-button>`)}
          </wui-flex>
        </wui-flex>
      </wui-flex>
...
`;var x=function(s,e,n,t){var a=arguments.length,o=a<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,n):t,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,n,t);else for(var d=s.length-1;d>=0;d--)(m=s[d])&&(o=(a<3?m(o):a>3?m(e,n,o):m(e,n))||o);return a>3&&o&&Object.defineProperty(e,n,o),o};let h=class extends y{constructor(){super(),this.unsubscribe=[],this.assets=i.state.assets,this.search="",this.onDebouncedSearch=I.debounce(e=>{this.search=e}),this.unsubscribe.push(i.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return r`
    ...
    `}onBuyClick(){w.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){i.setPaymentAsset(e),w.goBack()}};h.styles=v;x([u()],h.prototype,"assets",void 0);x([u()],h.prototype,"search",void 0);h=x([b("w3m-deposit-from-exchange-select-asset-view")],h);export{h as W3mDepositFromExchangeSelectAssetView,c as W3mDepositFromExchangeView};
