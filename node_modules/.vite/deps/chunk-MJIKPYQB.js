...
import {
  ...
  PresetsUtil,
  ProviderUtil
} from "./chunk-SDAHPEIE.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-LA7WAKNU.js";
import {
  EnsController,
  OnRampController,
  SIWXUtil,
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (((_d = OptionsController.state.features) == null ? void 0 : _d.reownAuthentication) || ((_e4 = OptionsController.state.remoteFeatures) == null ? void 0 : _e4.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-4QYC6UCI.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-GPEUU3LH.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-7AXRRNUH.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-WCLZZBID.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-7S45DHGZ.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-IY5QO5ZN.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-ZABD3JFI.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-PKV4NU7G.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-O7HWZTE5.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-VEIAV2KD.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-Z33LUGNF.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-YYXZ6UR5.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-LBANYZ54.js"),
      import("./w3m-modal-KOEVD75D.js")
    ]);
  }
};
...
*/
//# sourceMappingURL=chunk-MJIKPYQB.js.map
