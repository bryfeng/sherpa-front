...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (((_d = OptionsController.state.features) == null ? void 0 : _d.reownAuthentication) || ((_e4 = OptionsController.state.remoteFeatures) == null ? void 0 : _e4.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-WX3RH3PP.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-UPERDGTQ.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-OIU5CM7I.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-WA2TEZLT.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-JGHP7EFR.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-XAK2BL52.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-EMK7233G.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-RMA2X5FN.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-QRZ7CNXK.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-AK2VA36E.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-YKZXBZWG.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-O4BFAGTC.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-K4BVYGUE.js"),
      import("./w3m-modal-4I2PC5LC.js")
    ]);
  }
};
...
*/
//# sourceMappingURL=chunk-PEJFJE2Y.js.map
