...
function renderChatSurface(overrides: Partial<ChatSurfaceProps> = {}) {
  ...
  const props: ChatSurfaceProps = {
    ...
    onInputChange: vi.fn(),
    onSend: vi.fn(),
    proBadgeLabel: 'Pro Preview',
    pro: false,
    showProInfo: false,
    onDismissProInfo: vi.fn(),
    onProUpsell: vi.fn(),
    manualUnlockAvailable: false,
    onManualUnlock: vi.fn(),
    proRequirement: 'Requires upgrade',
    proTokenAddress: undefined,
    proContractDisplay: null,
    proExplorerUrl: undefined,
    copiedToken: false,
    onCopyToken: vi.fn(),
    ...overrides,
  }
