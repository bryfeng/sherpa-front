...
import { mainnet, polygon, arbitrum, optimism, base, baseSepolia, ink } from 'wagmi/chains'
...
const wagmiChains = [mainnet, base, baseSepolia, arbitrum, optimism, polygon, ink] as const
